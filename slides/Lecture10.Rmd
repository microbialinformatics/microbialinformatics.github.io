...
## Is the sex/species distribution the same? Expected

*** {name: left}

```{r expected, eval=F, echo=T}
...
```{r expected, eval=TRUE, echo=FALSE}
```
...
* Test against a ChiSquared distribution with (n~row~-1)*(n~col~-1) degrees of freedom
...
arrows(x0=chi.sq, x1=chi.sq, y0=0.25, y1=0.05, lwd=2, col="red")
```
